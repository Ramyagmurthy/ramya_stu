...
import image from "./../../assets/img/scholarship.jpg";
...
import smallImage from "../../assets/img/scholarship-small.jpg";
        ...
        <div className={classes.nav__bar}>
          ...
          <div className={classes.app__tools}>
            ...
            <Menu
              ...
              style={{ zIndex: "200" }}
            >
              <MenuItem onClick={handleCloseLogin} variant="selectedMenu">
                <Link
                  style={{ textDecoration: "none", color: "black" }}
                  to="/signin"
                >
              ...
              <MenuItem onClick={handleCloseLogin2}>New User ?</MenuItem>
            </Menu>
            <Menu
              id="stuordoast"
