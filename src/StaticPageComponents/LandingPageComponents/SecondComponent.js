        ...
        <div className={classes.first__part}>
          ...
          <div className={classes.words__box}>
            ...
            <Typography className={classes.about_explain}>
              At Studost, we believe in the power of big dreams! We are
              extremely passionate about fostering individual growth and
              building a sustainable future for aspirational students. We are
              highly committed to the cause of education and aim to transform
              lives by delivering the necessary funding through benefactors.{" "}
              {/* We
              pride ourselves in building the bridge between opportunity and
              success. */}
            </Typography>
          </div>
        </div>
