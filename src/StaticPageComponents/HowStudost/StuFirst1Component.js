import image from "./../../assets/img/woman-library.png";
import imageSmall from "../../assets/img/woman-library-small.png";
        ...
        <div className={classes.Hero__lettering}>
          <div className={classes.hero__second__conatiner}>
            <Typography className={classes.Hero__lettering__second}>
              Support a student’s dream by creating a
            </Typography>
            <Typography className={classes.Hero__lettering__first}>
              Studost fund today!
            </Typography>
          </div>
